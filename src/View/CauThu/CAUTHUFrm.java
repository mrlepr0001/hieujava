 ...
 * @author ADMIN
 */
public class CAUTHUFrm extends javax.swing.JFrame {
    ...
    public CAUTHUFrm() {
        initComponents();
        model = (DefaultTableModel) tblDSCT.getModel();
    ...
    private void initComponents() {
        ...
        tblDSCT = new javax.swing.JTable();
        ...
        tblDSCT.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String ten = (String) tblDSCT.getModel().getValueAt(row, 1);
            int tuoi = (int) tblDSCT.getModel().getValueAt(row, 2);
            double mucLuong = (double) tblDSCT.getModel().getValueAt(row, 3);
            
            CAUTHU cauThu = new CAUTHU(maCT, ten, tuoi, mucLuong);
            SUAFrm suaFrm = new SUAFrm(cauThu);
            suaFrm.show();
            this.dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CAUTHUFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblDSCT;
